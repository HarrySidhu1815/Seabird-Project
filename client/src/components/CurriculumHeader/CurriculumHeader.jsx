  ...
  return (
    <div className={classes.curriclum}>
      ...
      <p>
        ...
        appear in the 99 video mini-documentaries. <br/><br/>In addition, Dr. Dawn Marsden
        (Mississaugas of Scugog Island FN) and Seabird Island member Chelsea
        Forseth have also developed curriculum resources that are available
        here. <br/><br/>More resources will continue to be added as they are developed.<br/><br/>
        The UFV Collaboratorium students who contributed to the curriculum
        resources showcased here include XXXXXX
      </p>
    </div>
  );
}
